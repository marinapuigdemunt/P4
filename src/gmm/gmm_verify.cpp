...
float verify(const GMM &gmm_candidate, const fmatrix &dat)
{
	...
	// \DONE La función devuelve como score el logaritmo de la verosimilitud de la señal dado el modelo candidato
...
float verify(const GMM &gmm_candidate, const GMM & gmm_world, const fmatrix &dat, float &lprobcand, float &lprobbackground)
{
	 ...
	 */
	// \DONE Devuelve la diferencia entre el logaritmo de la verosimilitud de la señal dado el modelo del candidato y dado un modelo del mundo.
